...
//               // console.log("nested object inside ==>",val)
//               objProps(obj[val]);
//               // console.log(val,': ',obj[val]);
//             }else{
//               // console.log(val,': ',obj[val]);
//               let mydata = val +': '+ obj[val];
//               // console.log( mydata );
    ...
    try {
      ...
      fetch(filename
        ...
        .then(data => {
          ...
          //       console.log("nested object  ==>",val,' :')
          //       // const nodet = document.createElement("div");
          //       // nodet.style.cssText += 'color:red;background-color:yellow;padding: 10px;margin-right: 89%;font-weight: bold;border-radius: 10px;margin-top:2%;';
                
          //       // const textnodet = document.createTextNode(val + "=> : ");
          ...
          //       const nestedfun = (obj2) =>{
          //         for(let val2 in obj2){
          //         if(typeof obj2[val2] === 'object'){
          //           nestedfun(obj2[val2])
          //         }else{
          //           mydata = val2 +': '+ obj2[val2];
          //           console.log( mydata );
          //           const node = document.createElement("div");
          //           node.style.cssText += 'margin-left: 10%;margin-top: 1%;padding: 10px; color: black;background: white;font-weight: bold;border-radius: 10px;margin-right: 79%;'
          //           const textnode = document.createTextNode(mydata);
          ...
          //        console.log('           ' + origProp +' : index number '+ val,obj[val])
          //        const node = document.createElement("div");
          //        node.style.cssText += 'margin-left: 10%;margin-top: 1%;padding: 10px; color: black;background: yellow;font-weight: bold;border-radius: 10px;margin-right: 79%;'
          //        const textnode = document.createTextNode(origProp);
          //        node.appendChild(textnode);
          //        document.getElementById("mydiv").appendChild(node);
          //        //end of array key
          //        const arrtext = document.createElement("li");
          //        arrtext.style.cssText += 'margin-left: 23%;margin-top: 1%;padding: 20px; color: black;background: white;font-weight: bold;border-radius: 10px;margin-right: 50%;list-style:none;';
          //        const text = document.createTextNode('              '  +' : index number '+ val + ' is ' + obj[val])
          //        arrtext.appendChild(text);
          //        document.getElementById("mydiv").appendChild(arrtext);
          //     }else{
          //       mydata = val +': '+ obj[val];
          //       console.log( mydata );
          //       const node = document.createElement("div");
...
// const renderList = allmydata.map((item, index) => 
...
// );
  ...
  return (
    ...
    <input
        ...
        {/* <button  className='bg-red-700 rounded px-10 py-4 font-bold text-white cursor-pointer' onClick={traverse_it(data)}>map</button> */}
    <div className='text-white mt-8' id='mydiv'>
    <ul id="list"></ul>
    </div>
    {/* <textarea value={data} onChange={handleMessageChange} /> */}
    </>
  );
}
